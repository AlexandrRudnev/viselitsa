...
let btn = document.querySelectorAll('button'),
    ...
    life = document.querySelector('#la'),
    stroka = `Кант,Хроника,Зал,Галера,Балл,Вес,Кафель,Знак,Фильтр,Башня,Кондитер,
    Омар,Чан,Пламя,Банк,Тетерев,Муж,Камбала,Груз,Кино,лаваш,Калач,Геолог,Бальзам,
    Бревно,Жердь,Борец,Самовар,Карабин,Подлокотник,Барак,Мотор,Шарж,Сустав,Амфитеатр,
